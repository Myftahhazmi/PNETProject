document.addEventListener("DOMContentLoaded" , () => {
    ...
    a.addEventListener("click", () =>{
        ...
        image_api.src = "http://weather.vsg-labs.com/petronas_data/weatherchart/latest_SCS_wave_7.0days_24hourly_chart.gif";
    });
    
    b.addEventListener("click", () =>{
        title_api.textContent = "Peninsular Malaysia Forecast (7 Days)";
        image_api.src = "http://weather.vsg-labs.com/petronas_data/weatherchart/latest_PM_area_wave_7.0days_24hourly_chart.gif";
    });

    c.addEventListener("click", () =>{
        title_api.textContent = "Sabah and Sarawak Forecast (7 Days)";
        image_api.src = "http://weather.vsg-labs.com/petronas_data/weatherchart/latest_SarawakSabah_wave_7.0days_24hourly_chart.gif";
    });
