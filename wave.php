...
<body>
    <div class="mainpage-container">
        <div class="top-bar">
                ...
                <div class="main-page-title">WAVE REPORTS</div>
                <div class="main-page-info"></div>
        </div>

        <div class="main-container">
            <div class="over-container">
                <img src="http://weather.vsg-labs.com/petronas_data/weatherchart/latest_SCS_wave_7.0days_24hourly_chart.gif"alt="" class="fit-image" id="image-api">
